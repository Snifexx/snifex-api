...
/// @code
/// typedef struct {
///   t* ptr;     ///< @brief Pointer to the buffer of the internal C array
///   size_t cap; ///< @brief Capacity of the vector, I.E. size of the internal C array
///   size_t len; ///< @brief Actual length of the vector, I.E. amount of elements in the vector
...
/// @brief Pops value from the end of the vector, reducing it's length by 1
/// 
