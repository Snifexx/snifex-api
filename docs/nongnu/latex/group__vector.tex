...
\#define \mbox{\hyperlink{group__vector_gaf9fe084ed81987e135bb09f2e3179fbb}{vec\+\_\+create}}(lval\+\_\+result\+\_\+vec,  t,  init\+\_\+cap)
...
\#define \mbox{\hyperlink{group__vector_ga9f032ff8f2b7ec2165db1563fd65ba84}{vec\+\_\+from}}(lval\+\_\+result\+\_\+vec,  t,  item1, ...)
\begin{DoxyCompactList}\small\item\em Create a vector from a list of initial elements. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{group__vector_ga34057adbd9b0356ce0a766607286dbb9}{vec\+\_\+idx}}(lval\+\_\+result\+\_\+elem\+\_\+ptr,  t,  vec,  i)
\begin{DoxyCompactList}\small\item\em Get pointer to element of vector at specific index. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{group__vector_ga80aa2e68426868fad938dae1349138d1}{vec\+\_\+last}}(lval\+\_\+result\+\_\+elem\+\_\+ptr,  t,  vec)
\begin{DoxyCompactList}\small\item\em Get pointer to last element of vector. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{group__vector_ga7584cabf1cdae1b93c7e1ccdf465ca0e}{vec\+\_\+push}}(t,  vec\+\_\+ptr,  val)
\begin{DoxyCompactList}\small\item\em Pushes value to the end of the vector. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{group__vector_gaae6aa5a0abd0316eb0054c9ad528f11e}{vec\+\_\+pop}}(t,  vec\+\_\+ptr)
...
\#define \mbox{\hyperlink{group__vector_ga79c2425d873d0991780a4052606a1d63}{vec\+\_\+append}}(t,  front\+\_\+ptr,  back)
\begin{DoxyCompactList}\small\item\em Appends items from a vector to the back of another vector. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{group__vector_ga3758b6852e3caea88dc02f8f1d618539}{vec\+\_\+swap\+\_\+remove}}(t,  vec\+\_\+ptr,  idx)
...
\end{DoxySeeAlso}
\Hypertarget{group__vector_ga79c2425d873d0991780a4052606a1d63}\label{group__vector_ga79c2425d873d0991780a4052606a1d63} 
...
{\footnotesize\ttfamily \#define vec\+\_\+append(\begin{DoxyParamCaption}\item[{}]{t,  }\item[{}]{front\+\_\+ptr,  }\item[{}]{back }\end{DoxyParamCaption})}
...
\end{DoxyPostcond}
\Hypertarget{group__vector_gaf9fe084ed81987e135bb09f2e3179fbb}\label{group__vector_gaf9fe084ed81987e135bb09f2e3179fbb} 
...
{\footnotesize\ttfamily \#define vec\+\_\+create(\begin{DoxyParamCaption}\item[{}]{lval\+\_\+result\+\_\+vec,  }\item[{}]{t,  }\item[{}]{init\+\_\+cap }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em lval\+\_\+result\+\_\+vec} & An lvalue of type {\ttfamily \doxylink{group__vector_ga21ec81b33f2746d76b94b77c7f990379}{Vec(t)}} to which the result is going to be set \\
\hline
{\em t} & The type of the elements in the vector \\
\hline
...
\hline
\end{DoxyParams}
\Hypertarget{group__vector_ga9f032ff8f2b7ec2165db1563fd65ba84}\label{group__vector_ga9f032ff8f2b7ec2165db1563fd65ba84} 
...
{\footnotesize\ttfamily \#define vec\+\_\+from(\begin{DoxyParamCaption}\item[{}]{lval\+\_\+result\+\_\+vec,  }\item[{}]{t,  }\item[{}]{item1,  }\item[{}]{... }\end{DoxyParamCaption})}
...
\end{DoxyPrecond}
\Hypertarget{group__vector_ga34057adbd9b0356ce0a766607286dbb9}\label{group__vector_ga34057adbd9b0356ce0a766607286dbb9} 
...
{\footnotesize\ttfamily \#define vec\+\_\+idx(\begin{DoxyParamCaption}\item[{}]{lval\+\_\+result\+\_\+elem\+\_\+ptr,  }\item[{}]{t,  }\item[{}]{vec,  }\item[{}]{i }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em lval\+\_\+result\+\_\+elem\+\_\+ptr} & An lvalue of type {\ttfamily t\texorpdfstring{$\ast$}{*}} to which the result is going to be set \\
\hline
{\em t} & The type of the elements in the vector \\
\hline
...
\end{DoxyPrecond}
\Hypertarget{group__vector_ga80aa2e68426868fad938dae1349138d1}\label{group__vector_ga80aa2e68426868fad938dae1349138d1} 
...
{\footnotesize\ttfamily \#define vec\+\_\+last(\begin{DoxyParamCaption}\item[{}]{lval\+\_\+result\+\_\+elem\+\_\+ptr,  }\item[{}]{t,  }\item[{}]{vec }\end{DoxyParamCaption})}
...
{\ttfamily vec.\+ptr != NULL} (which should be true if the user did not mess with the {\ttfamily ptr} directly) 
\end{DoxyPrecond}
\Hypertarget{group__vector_gaae6aa5a0abd0316eb0054c9ad528f11e}\label{group__vector_gaae6aa5a0abd0316eb0054c9ad528f11e} 
...
{\footnotesize\ttfamily \#define vec\+\_\+pop(\begin{DoxyParamCaption}\item[{}]{t,  }\item[{}]{vec\+\_\+ptr }\end{DoxyParamCaption})}
...
\end{DoxyPrecond}
\Hypertarget{group__vector_ga7584cabf1cdae1b93c7e1ccdf465ca0e}\label{group__vector_ga7584cabf1cdae1b93c7e1ccdf465ca0e} 
...
{\footnotesize\ttfamily \#define vec\+\_\+push(\begin{DoxyParamCaption}\item[{}]{t,  }\item[{}]{vec\+\_\+ptr,  }\item[{}]{val }\end{DoxyParamCaption})}
...
\end{DoxyPostcond}
\Hypertarget{group__vector_ga3758b6852e3caea88dc02f8f1d618539}\label{group__vector_ga3758b6852e3caea88dc02f8f1d618539} 
...
{\footnotesize\ttfamily \#define vec\+\_\+swap\+\_\+remove(\begin{DoxyParamCaption}\item[{}]{t,  }\item[{}]{vec\+\_\+ptr,  }\item[{}]{idx }\end{DoxyParamCaption})}
