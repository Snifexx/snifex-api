\doxysection{Arena}
\hypertarget{group__arena}{}\label{group__arena}\index{Arena@{Arena}}
...
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{group__arena_ga42cd5df57e48132617fffea48005b8b0}{dyn\+\_\+arena\+\_\+get}}(lval\+\_\+result\+\_\+t\+\_\+ptr,  t,  \mbox{\hyperlink{structdyn__arena}{dyn\+\_\+arena}},  rel\+\_\+ptr)
...
\Hypertarget{group__arena_ga42cd5df57e48132617fffea48005b8b0}\label{group__arena_ga42cd5df57e48132617fffea48005b8b0} 
\index{Arena@{Arena}!dyn\_arena\_get@{dyn\_arena\_get}}
\index{dyn\_arena\_get@{dyn\_arena\_get}!Arena@{Arena}}
\doxysubsubsection{\texorpdfstring{dyn\_arena\_get}{dyn\_arena\_get}}
{\footnotesize\ttfamily \#define dyn\+\_\+arena\+\_\+get(\begin{DoxyParamCaption}\item[{}]{lval\+\_\+result\+\_\+t\+\_\+ptr,  }\item[{}]{t,  }\item[{}]{\mbox{\hyperlink{structdyn__arena}{dyn\+\_\+arena}},  }\item[{}]{rel\+\_\+ptr }\end{DoxyParamCaption})}
...
{\em lval\+\_\+result\+\_\+t\+\_\+ptr} & An lvalue of type {\ttfamily t\texorpdfstring{$\ast$}{*}} to which the result is going to be set \\
\hline
...
\index{Arena@{Arena}!DynArena@{DynArena}}
\index{DynArena@{DynArena}!Arena@{Arena}}
...
An arena that is not fixed-\/sized, and dynamically grows. Because of this property, \doxylink{group__arena_gaf51416939c44395d6d982750c464ab44}{dyn\+\_\+arena\+\_\+alloc} does not return a pointer, it returns an index with which we can access the pointer temporarily (with \doxylink{group__arena_ga42cd5df57e48132617fffea48005b8b0}{dyn\+\_\+arena\+\_\+get}) 

\doxysubsection{Function Documentation}
\Hypertarget{group__arena_gafa4a34eff8578b37c7fa9a3e12188959}\label{group__arena_gafa4a34eff8578b37c7fa9a3e12188959} 
\index{Arena@{Arena}!arena\_alloc@{arena\_alloc}}
\index{arena\_alloc@{arena\_alloc}!Arena@{Arena}}
...
\index{Arena@{Arena}!arena\_create@{arena\_create}}
\index{arena\_create@{arena\_create}!Arena@{Arena}}
...
\index{Arena@{Arena}!arena\_init@{arena\_init}}
\index{arena\_init@{arena\_init}!Arena@{Arena}}
...
\index{Arena@{Arena}!dyn\_arena\_alloc@{dyn\_arena\_alloc}}
\index{dyn\_arena\_alloc@{dyn\_arena\_alloc}!Arena@{Arena}}
...
Allocates object of size \textquotesingle{}{\ttfamily size}\textquotesingle{} aligned to \textquotesingle{}{\ttfamily alignment}\textquotesingle{}. If unsure of what to use as {\ttfamily alignment}, just use the {\ttfamily size} \begin{DoxyReturn}{Returns}
Returns an index from {\ttfamily dyn\+\_\+arena-\/\texorpdfstring{$>$}{>}buf}. To get the obect at that index refer to \doxylink{group__arena_ga42cd5df57e48132617fffea48005b8b0}{dyn\+\_\+arena\+\_\+get} 
\end{DoxyReturn}
\Hypertarget{group__arena_ga5cf19a838d5dca54e91d85cf1a316a35}\label{group__arena_ga5cf19a838d5dca54e91d85cf1a316a35} 
\index{Arena@{Arena}!dyn\_arena\_create@{dyn\_arena\_create}}
\index{dyn\_arena\_create@{dyn\_arena\_create}!Arena@{Arena}}
...
\index{Arena@{Arena}!dyn\_arena\_init@{dyn\_arena\_init}}
\index{dyn\_arena\_init@{dyn\_arena\_init}!Arena@{Arena}}
...
\index{Arena@{Arena}!dyn\_arena\_reserve@{dyn\_arena\_reserve}}
\index{dyn\_arena\_reserve@{dyn\_arena\_reserve}!Arena@{Arena}}
